...
<body>
    <div class="">
        ...
        <div class="container">
          <div class="mb-5 columns is-multiline is-centered">
            <div class="column is-8">
              <img class="image is-fullwidth" src="/assets/images/shrewdeye-avatar-2.jpg" alt="">
            </div>
          </div>
          <div class="has-text-centered">
            <span class="has-text-grey-dark">Error 419</span>
      ...
      <a class="button is-primary is-rounded is-large" href="/">Go back to dashboard</a>
      </div>
          </div>
        </div>
      </section>
